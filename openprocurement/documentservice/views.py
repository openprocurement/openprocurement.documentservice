...
from openprocurement.documentservice.utils import error_handler, storage_error_handler, context_unpack
...
def register_view(request):
    ...
    try:
        ...
        return storage_error_handler(request, 502, exc.message)
